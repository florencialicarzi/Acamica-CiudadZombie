...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_derecha.png', 300, 400, 30,15,2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 300, 415, 30,15,2),
    new Obstaculo('imagenes/bache.png', 540, 240, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 510, 240, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 310, 150, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 830, 400, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 815, 390, 15, 30, 2),
    new Obstaculo('imagenes/valla_vertical.png', 580, 110, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 790, 200, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 150, 250, 30, 30, 1),
  ...
  enemigos: [
    ...
    new ZombieCaminante('imagenes/zombie1.png', 600, 300, 10, 10, 1, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 800, 300, 10, 10, 1, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png', 600, 100, 10, 10, 1, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie4.png', 600, 120, 10, 10, 1, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie1.png', 270, 400, 10, 10, 1, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),

    new ZombieConductor('imagenes/tren_vertical.png', 644, 450, 30, 90, 5, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}, "v"),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 5, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}, "v"),
    new ZombieConductor('imagenes/tren_horizontal.png', 200, 322, 90, 30, 2 , {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}, "h"),
    new Avion('imagenes/avion.png', 400, 215, 30, 30, 3 , {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}, "h"),
    new Avion('imagenes/avion.png', 300, 400, 30, 30, 1 , {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}, "v"),
    new Avion('imagenes/avion.png', 900, 400, 30, 30, 2 , {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}, "h"),
  ]
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      obstaculo.chocarJugador(this.jugador);
      puedeMoverse = false
    }
  }, this)
  return puedeMoverse
